...
//unsigned int scr_obj[GAME_SCR_MAX_INDEX]; <---TODO TO BE USED TO STORE OBJECT PICKING AS BIT'S

unsigned char scr_curr;
unsigned char map_width;
unsigned char map_heigth;
//Compressed MAP
unsigned char scr_0[] = 	{58,130,70,130,32,90,130,32,70,130,0,32,0,32,130,0,58,130,0,130,70,58,130,70,130,0,32,0,49,0,32,0,58,0,32,0,96,58,132,0,32,131,0,32,0,58,132,0,58,134,0,49,131,0,58,0,132,70,94,95,130,0,93,0,93,0,93,0,58,135,0,58,135,70,58,135,0,58,134,32,70,58,132,0,92,130,0,58,138,70,130,40,130,70,137,40}	;

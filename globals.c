...
unsigned char scr_0[] = {
    141, 0,   7,  8,  131, 0,   32, 0,   32,  131, 0,   24, 25,  26,
    27,  0,   9,  10, 132, 0,   73, 141, 0,   32,  0,   32, 0,   32,
    130, 0,   32, 33, 34,  35,  36, 0,   11,  12,  135, 0,  65,  66,
    67,  68,  69, 70, 71,  56,  68, 0,   72,  131, 73,  74, 136, 0,
    56,  139, 0,  5,  6,   130, 0,  56,  138, 0,   1,   2,  3,   4,
    0,   56,  0,  72, 131, 73,  74, 131, 42,  72,  134, 73, 74};
unsigned char scr_1[] = {
    141, 0,  7,   8,   135, 0,  24,  0, 25, 0,   26, 0,   27, 9,   10, 151, 0,
    11,  12, 136, 0,   138, 70, 131, 0, 70, 58,  70, 130, 0,  131, 68, 131, 44,
    134, 0,  58,  131, 0,   68, 130, 0, 32, 132, 0,  5,   6,  130, 0,  58,  133,
    0,   68, 132, 0,   1,   2,  3,   4, 0,  58,  0,  134, 70, 130, 42, 136, 70};
unsigned char scr_2[] = {132, 0,   131, 32,  134, 0,   7,  8,   133, 0,   131,
                         32,  132, 0,   70,  0,   9,   10, 133, 0,   131, 32,
                         163, 0,   68,  70,  68,  131, 0,  65,  66,  67,  56,
                         65,  67,  141, 0,   56,  134, 0,  5,   6,   133, 0,
                         11,  12,  56,  133, 0,   1,   2,  3,   4,   131, 0,
                         72,  131, 73,  74,  131, 42,  72, 134, 73,  74};
unsigned char scr_3[] = {
    130, 0,   7,   8,   131, 0,   137, 71,  130, 0,   9,  10,  131, 0,
    133, 71,  130, 0,   27,  136, 0,   133, 71,  146, 0,  42,  135, 0,
    57,  137, 71,  134, 0,   57,  137, 71,  134, 0,   57, 137, 71,  134,
    0,   57,  137, 71,  72,  131, 73,  74,  130, 42,  72, 135, 73,  74};
unsigned char scr_4[] = {
    138, 71,  131, 0,   7,  8,   131, 0,   26,  0,   71,  130, 0,  27,  0,
    71,  131, 0,   9,   10, 133, 0,   59,  132, 0,   71,  138, 0,  59,  139,
    0,   71,  44,  45,  71, 59,  71,  130, 45,  134, 71,  57,  0,  132, 71,
    59,  133, 71,  131, 0,  71,  57,  0,   71,  0,   130, 32,  59, 130, 32,
    130, 0,   71,  5,   6,  0,   71,  57,  0,   71,  0,   130, 32, 59,  130,
    32,  130, 0,   1,   2,  3,   4,   0,   57,  0,   72,  142, 73, 74};
unsigned char scr_5[] = {
    0,   7,   8,  135, 0,   32, 0,  32,  0,   32, 130, 0,   9,  10,  134, 0,
    53,  133, 54, 55,  140, 0,  23, 135, 0,   32, 0,   32,  0,  32,  131, 0,
    22,  135, 0,  53,  131, 54, 55, 131, 0,   22, 132, 0,   32, 132, 0,   23,
    133, 0,   22, 131, 0,   53, 54, 55,  131, 0,  22,  133, 0,  22,  132, 0,
    23,  132, 0,  22,  133, 0,  22, 131, 0,   72, 142, 73,  74};
unsigned char scr_6[] = {
    132, 0,   32,  134, 0,   7,   8,  134, 0,   32,  48,  134, 0,   9, 10, 134,
    0,   32,  48,  0,   32,  130, 0,  32,  136, 0,   32,  48,  142, 0, 32, 48,
    130, 0,   32,  0,   48,  0,   48, 0,   32,  133, 0,   48,  143, 0, 48, 131,
    0,   48,  131, 0,   5,   6,   48, 132, 0,   11,  12,  134, 0,   1, 2,  3,
    4,   131, 0,   72,  131, 73,  74, 131, 42,  72,  134, 73,  74};
unsigned char scr_7[] = {
    136, 0,   21, 132, 0,  7,  8,   137, 0,   20, 131, 0,  21,  9,   10,
    137, 0,   20, 131, 0,  20, 136, 0,   67,  58, 0,   20, 130, 0,   131,
    19,  134, 0,  130, 67, 58, 0,   20,  130, 0,  17,  13, 18,  133, 0,
    131, 67,  58, 0,   20, 0,  19,  131, 16,  19, 131, 0,  132, 67,  58,
    0,   20,  0,  17,  13, 14, 13,  18,  130, 0,  133, 67, 58,  0,   20,
    0,   17,  13, 15,  13, 18, 0,   72,  142, 73, 74};
